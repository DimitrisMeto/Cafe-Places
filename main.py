...
class CafeForm(FlaskForm):
    ...
    close = StringField('Closing Time ee.g. 5:30PM', validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', newline='', mode='a') as csv_file:
            csv_file.write(f"\n{form.cafe.data}, {form.cafe_location.data}, {form.open.data}, {form.close.data}, {form.rating.data}, {form.wifi.data}, {form.power.data}")
